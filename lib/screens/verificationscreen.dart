...
class _PinCodeVerificationScreenState extends State<PinCodeVerificationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   backgroundColor: Colors.white,
      //   elevation: 0,
      //   title: Center(child: Text("Verification",style: TextStyle(fontWeight: FontWeight.w700,fontSize: 20,color: Colors.black),)),
      // ),
      body:
       GestureDetector(
        onTap: () {},
            ...
            children: <Widget>[
                ...
                child: Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Verification",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w700,fontSize: 20),),
                    )
                  ],
                ),
              ),
              ...
              const Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22,color: Color(0xFF667080)),
